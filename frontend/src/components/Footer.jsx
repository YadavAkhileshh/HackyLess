        ...
        <div class="max-w-screen-xl px-4 pt-16 pb-6 mx-auto sm:px-6 lg:px-8 lg:pt-24">
          <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
            <div>
              ...
              <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white">HackyLess</h1>
            ...
            <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:col-span-2 md:grid-cols-4">
              ...
              <div class="text-center sm:text-left">
                <p class="text-lg font-medium text-white">For Developers</p>
              ...
              <div class="text-center sm:text-left">
                <p class="text-lg font-medium text-white">Knowledge</p>
          ...
          <div class="pt-6 mt-12 border-t border-gray-800">
            <div class="text-center sm:flex sm:justify-between sm:text-left">
              ...
              <p class="mt-4 text-sm text-gray-500 sm:order-first sm:mt-0">
                &copy; 2025 HackyLess | All Right Reserved
              </p>
            </div>
          </div>
        </div>
